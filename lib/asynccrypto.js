...
let inject = function (deps) {
  ...
  AsyncCrypto.prototype.xkeysFromEntropy = function (entropybuf) {
    ...
    return q(this.pool.exec('xkeysFromEntropyHex', [entropyhex])).then(function (obj) {
  ...
  AsyncCrypto.prototype.verifyCompactSig = function (hashbuf, sig) {
    ...
    return q(this.pool.exec('verifyCompactSig', [hashhex, signatureHex])).then(function (obj) {
      return {

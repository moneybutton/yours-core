...
Peers.prototype.asyncInitialize = function () {
  return spawn(function *() {
    ...
    yield networkWebRTC.asyncInitialize()
...
Peers.prototype.monitorNetworkWebRTC = function () {
  this.networks.webrtc.on('error', this.handleNetworkWebRTCError.bind(this))
  this.networks.webrtc.on('connection', this.handleNetworkWebRTCConnection.bind(this))
  this.networks.webrtc.on('disconnected', this.handleNetworkWebRTCDisconnected.bind(this))
  this.networks.webrtc.on('msg', this.handleNetworkWebRTCMsg.bind(this))
  return this
}

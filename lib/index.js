 ...
 *
 * The bitcoinOnly option lets you initialize the bitcoin blockchain API, but
 * NOT the datt p2p network. This would be for when you wish to use the bitcoin
 * wallet, but not distribute or receive content over the datt p2p network.
 */
Datt.prototype.asyncNetworkInitialize = function (opts) {
  return asink(function *() {

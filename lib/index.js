...
DattCore.prototype.asyncInitialize = function () {
  return spawn(function *() {
    ...
    // possible to run the app with broken network connections. Obviously not
    ...
    // off the network connection initialization here - we just don't want for
    // it to finish before resolving.

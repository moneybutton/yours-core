...
Datt.prototype.onConnectionData = function onConnectionData (data) {
...
Datt.prototype.askPeersForPeersForContent = function askPeersForPeersForContent (hash) {
  var message = Message.requestPeersForHash(hash, this)

...
CoreContent.prototype.asyncGetRecentContentAuth = function () {
  return asink(function *() {
    // TODO: This should *NOT* sort all content in memory. Use a database
    // index.
    let contentauths = yield DBContentAuth(this.db).asyncGetAll()
    contentauths.sort((a, b) => b.date.getTime() - a.date.getTime())
    return contentauths
  }, this)
}
